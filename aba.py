...
# ---------- Zone principale ----------
if df.empty:
    st.info("Aucun trajet. Ajoutez-en via le formulaire.")
    st.stop()
...
# Affichage sans decimales pour les km
